...
const ChatContainer : React.FC<{socket: Socket, user: UserModel, logout:Function, chats: ChatModel[]}> = ({socket, user, logout}) => {
    ...
    const sendOpenPrivateMessage = (receiver : UserModel) => {
