...
export default function SideBar(chats, activeChat,  logout, user, setActiveChat, onSendPrivateMessage) : React.FC<{chats: ChatData[], activeChat: any, logout:Function, user: {id:number, name:string} | null, setActiveChat:Function, onSendPrivateMessage: Function}>{
    ...
    return(
            <div id="side-bar">
                ...
                <div className="users"
                    onClick={(e)=>{(e.target === props.user) && props.setActiveChat(null)}}>
