...
export default class ChatContainer extends Component<{socket: Socket | null, user: UserModel, logout:Function},{chats: ChatModel[], activeChat: ChatModel | null}>{
                ...
                <div className="chat-room-container">
                    {
                        activeChat !== null ?(
                            <div className="chat-room">
                                <ChatHeading name={activeChat.name} id={''} users={[]} messages={[]} typingUsers={[]}/>
                                <Messages
