...
export default class ChatContainer extends Component<{socket: Socket | null, user:{id:number, name:string} | null, logout:Function},{chats: any, activeChat: any | null}>{
    ...
    constructor(props : any)
    {
        ...
        this.state=
        {
        chats:[{name:"Trying", messages:"loading", users : {name:"null"}}],
        activeChat: null
        }
    }
