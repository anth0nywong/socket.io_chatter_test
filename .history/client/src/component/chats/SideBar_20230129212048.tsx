...
const SideBar : React.FC<{chats: ChatData[], activeChat: any, logout:Function, user: {id:number, name:string}, setActiveChat:Function, onSendPrivateMessage: Function, userList: UserModel[]}>
    ...
    return(
            <div id="side-bar">
                ...
                <form onSubmit={handleSubmit} className="search">
                    ...
                    <select value={receiver} onChange={(e)=>{setReceiver(e.target.value)}} placeholder="Search">
