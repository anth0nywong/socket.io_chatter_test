...
export default class ChatContainer extends Component<{socket: Socket | null, user:{id:number, name:string}, logout:Function},{chats: ChatData[], activeChat: ChatData | null}>{
