...
const SideBar : React.FC<{chats: ChatData[], activeChat: any, logout:Function, user: {id:number, name:string}, setActiveChat:Function, onSendPrivateMessage: Function, userList: Object}>
    ...
    return(
            <div id="side-bar">
                ...
                <form onSubmit={handleSubmit} className="search">
                    ...
                    <select onChange={(e)=>{setReceiver(e.target.value)}} placeholder="Search">
                        {()=>{
                            return Object.keys(userList).reduce((key, index)=>{
                                if(userList[key])
                            return(<option key={index} value={userList[key].name}>Volvo</option>);
                        })}}
                    </select>
