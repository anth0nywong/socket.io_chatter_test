...
export default class SideBar extends Component<{chats: ChatData[], activeChat: any, logout:Function, user: {id:number, name:string} | null, setActiveChat:Function}, {receiver: string, onSendPrivateMessage: Function | null}>{
