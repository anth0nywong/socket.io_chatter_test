...
export default class ChatContainer extends Component<{socket: Socket | null, user:{id:number, name:string} | null, logout:Function},{chats: any, activeChat: any | null, name:any}>{
