...
import UserMdodel from '../../model/user';

export default class SideBar extends Component<{chats: ChatData[], activeChat: any, logout:Function, user: {id:number, name:string} | null, setActiveChat:Function, onSendPrivateMessage: Function}, {receiver: UserModel}>{
