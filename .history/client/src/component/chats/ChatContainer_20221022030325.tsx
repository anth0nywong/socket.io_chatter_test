...
export default class ChatContainer extends Component<{socket: Socket, user: UserModel, logout:Function},{chats: ChatModel[], activeChat: ChatModel | null, listener: string[]}>{
    ...
    componentWillUnmount(){
        const{socket} = this.props;
        socket.removeListener(messageEvent);
    }
